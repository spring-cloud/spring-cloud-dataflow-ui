...
export class ElementHelper {
    ...
    public static async getElementOrWait(byValue: By): Promise<By> {
        let conditionA = EC.visibilityOf(element(byValue));
        let conditionB = EC.invisibilityOf(element(By.css('.app-blocker')));
        let conditionC = EC.invisibilityOf(element(By.css('modal-body')));
        return browser.wait(
    ...
    public static getClickableElementOrWait(by: By) {
        let conditionA = EC.visibilityOf(element(by));
        let conditionB = EC.invisibilityOf(element(By.css('.app-blocker')));
        let conditionC = EC.invisibilityOf(element(By.css('modal-body')));
        return browser.wait(
