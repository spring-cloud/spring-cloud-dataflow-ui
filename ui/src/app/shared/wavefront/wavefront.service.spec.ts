...
describe('shared/wavefront/wavefront.service.ts', () => {
  ...
  it('Should be allow', () => {
    wavefrontService.isAllowed().subscribe(allow => {
  ...
  it('Should return the streams URL dashboard', () => {
    wavefrontService.getDashboardStreams().subscribe(url => {
      expect(url).toBe(
  ...
  it('Should return the stream URL dashboard', () => {
    wavefrontService.getDashboardStream({name: 'bar'}).subscribe(url => {
      expect(url).toBe(
  ...
  it('Should return the stream application URL dashboard', () => {
    wavefrontService.getDashboardApplication('bar1', 'bar2').subscribe(url => {
      expect(url).toBe(
  ...
  it('Should return the stream application instance URL dashboard', () => {
    wavefrontService.getDashboardApplicationInstance('bar1', 'bar2', 'bar3').subscribe(url => {
      expect(url).toBe(
  ...
  it('Should return the tasks URL dashboard', () => {
    wavefrontService.getDashboardTasks().subscribe(url => {
      expect(url).toBe(
  ...
  it('Should return the task URL dashboard', () => {
    wavefrontService.getDashboardTask({name: 'bar'}).subscribe(url => {
      expect(url).toBe(
  ...
  it('Should return the task execution URL dashboard', () => {
    wavefrontService.getDashboardTaskExecution({taskName: 'bar1', executionId: 'bar2'}).subscribe(url => {
      expect(url).toBe(
