...
export class AboutInfo implements Serializable<AboutInfo> {
    ...
    public monitoringDashboardInfo = new MonitoringDashboardInfo();
    ...
    public deserialize(input) {
      ...
      this.monitoringDashboardInfo = new MonitoringDashboardInfo().deserialize(input.monitoringDashboardInfo);
      return this;
    }
  }
