...
export const getContexts = (state: State) => state[contextFeatureKey];

export const getContext = (contexts: ContextModel[], name: string) => contexts.find(s => s.name === name)?.value;
