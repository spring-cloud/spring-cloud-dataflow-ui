...
export const getVersions = (state: State) => state[aboutFeatureKey].versions;

export const getFeatures = (state: State) => state[aboutFeatureKey].features;

export const getRuntimeEnvironment = (state: State) => state[aboutFeatureKey].runtimeEnvironment;

export const getAbout = (state: State) => state[aboutFeatureKey];

export const getMonitoring = (state: State) => state[aboutFeatureKey].monitoringDashboardInfo;

export const getSecurity = (state: State) => state[aboutFeatureKey].security;
