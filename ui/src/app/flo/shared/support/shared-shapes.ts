...
export function loadSharedShapes() {
    ...
    // The path is the open/close arrow, defaults to vertical (open)
        markup: '<g><rect class="outer"/><rect class="group-label-bg"/><text class="group-label"/>'
        + '<image class="collapse-handle light"/><image class="collapse-handle2 dark"/><polyline class="group-line"/></g>',
