...
describe('parser:', () => {
  ...
  it('simplify stream dsl 1', () => {
    expect(Parser.simplify(' file | log  ')).toEqual('file | log');
  });

  it('simplify stream dsl 2', () => {
    expect(Parser.simplify(' file --tt=ii | log  ')).toEqual('file | log');
  });

  it('simplify stream dsl 3', () => {
    expect(Parser.simplify(' file --tt=ii  |   log --hg=dcdscdc   --jj.hjt=ooooo ')).toEqual('file | log');
  });

  it('simplify stream dsl 4', () => {
    expect(Parser.simplify('aaa: time | log')).toEqual('aaa: time | log');
  });

  it('simplify stream dsl 5', () => {
    expect(Parser.simplify('aaa --bbb="ccc"')).toEqual('aaa');
  });

  it('simplify stream dsl 6', () => {
    expect(Parser.simplify('aaa --bbb="ccc  tttt  "  ')).toEqual('aaa');
  });
