...
export const getSecurity = (state: State) => state[securityFeatureKey];

export const getEnabled = (state: State) => state[securityFeatureKey].enabled;

export const getAuthenticated = (state: State) => state[securityFeatureKey].authenticated;

export const getUsername = (state: State) => state[securityFeatureKey].username;

export const getRoles = (state: State) => state[securityFeatureKey].roles;
