        ...
        options: [
          {
            ...
            hints: {
              ...
              keyProviders: [],
              valueHints: [
                {value: 'y', description: null, shortDescription: null},
                {
                  value: 'n',
                  description: null,
                  shortDescription: null
          ...
          },
          {
            ...
            shortDescription:
              'Flag to indicate whether application properties are passed as command line args or ' +
          ...
          },
          {
            ...
            shortDescription:
              'Maximum number of seconds to wait for application shutdown. via the {@code /shutdown} ' + 'endpoint.',
            defaultValue: 30,
            hints: {keyHints: [], keyProviders: [], valueHints: [], valueProviders: []},
            deprecation: null,
            deprecated: false
