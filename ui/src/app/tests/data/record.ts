    ...
    auditRecordResourceList: [
      {
        ...
        auditData:
          '{"APP_NAME":"aggregator","APP_TYPE":"processor","APP_VERSION":"2.1.1.RELEASE","uri":"docker:springcloudstream/aggregator-processor-kafka:2.1.1.RELEASE","APP_IS_DEFAULT":true,"metaDataUri":null}',
      ...
      },
      {
        ...
        correlationId: 'aggregator',
        auditData:
          '{"APP_NAME":"aggregator","APP_TYPE":"processor","APP_VERSION":"2.1.2.RELEASE","uri":"docker:springcloudstream/aggregator-processor-kafka:2.1.2.RELEASE","APP_IS_DEFAULT":true,"metaDataUri":"maven://org.springframework.cloud.stream.app:aggregator-processor-kafka:jar:metadata:2.1.2.RELEASE"}',
      ...
      },
      {
        ...
        correlationId: 'aggregator',
        auditData:
          '{"APP_NAME":"aggregator","APP_TYPE":"processor","APP_VERSION":"2.1.1.RELEASE","uri":"docker:springcloudstream/aggregator-processor-kafka:2.1.1.RELEASE","APP_IS_DEFAULT":false,"metaDataUri":null}',
      ...
      },
      {
        ...
        correlationId: 'aggregator',
        auditData:
          '{"APP_NAME":"aggregator","APP_TYPE":"processor","APP_VERSION":"2.1.2.RELEASE","uri":"","APP_IS_DEFAULT":false,"metaDataUri":""}',
      ...
      },
      {
        ...
        correlationId: 'aggregator',
        auditData:
          '{"APP_NAME":"aggregator","APP_TYPE":"processor","APP_VERSION":"2.1.1.RELEASE","uri":"","APP_IS_DEFAULT":false,"metaDataUri":""}',
      ...
      },
      {
        ...
        correlationId: 'aggregator',
        auditData:
          '{"APP_NAME":"aggregator","APP_TYPE":"processor","APP_VERSION":"2.1.2.RELEASE","uri":"docker:springcloudstream/aggregator-processor-kafka:2.1.2.RELEASE","APP_IS_DEFAULT":true,"metaDataUri":null}',
      ...
      },
      {
        ...
        correlationId: 'aggregator',
        auditData:
          '{"APP_NAME":"aggregator","APP_TYPE":"processor","APP_VERSION":"2.1.0.RELEASE","uri":"","APP_IS_DEFAULT":false,"metaDataUri":""}',
      ...
      },
      {
        ...
        correlationId: 'aggregator',
        auditData:
          '{"APP_NAME":"aggregator","APP_TYPE":"processor","APP_VERSION":"2.1.0.RELEASE","uri":"docker:springcloudstream/aggregator-processor-kafka:2.1.0.RELEASE","APP_IS_DEFAULT":false,"metaDataUri":null}',
      ...
      },
      {
        ...
        auditData:
          '{"APP_NAME":"sample","APP_TYPE":"app","APP_VERSION":"1.0.0.BUILD-SNAPSHOT","uri":"maven://io.spring.cloud:scdf-sample-app:jar:1.0.0.BUILD-SNAPSHOT","APP_IS_DEFAULT":true,"metaDataUri":null}',
      ...
      },
      {
        ...
        correlationId: 'sample',
        auditData:
          '{"APP_NAME":"sample","APP_TYPE":"app","APP_VERSION":"1.0.1.BUILD-SNAPSHOT","uri":"maven://io.spring.cloud:scdf-sample-app:jar:1.0.1.BUILD-SNAPSHOT","APP_IS_DEFAULT":true,"metaDataUri":null}',
        createdOn: '2020-05-18T13:24:00Z',
        auditAction: 'CREATE',
        auditOperation: 'APP_REGISTRATION',
        platformName: null,
      ...
      },
      {
        ...
        correlationId: 'sample',
        auditData:
          '{"APP_NAME":"sample","APP_TYPE":"app","APP_VERSION":"1.2.2.BUILD-SNAPSHOT","uri":"maven://io.spring.cloud:scdf-sample-app:jar:1.2.2.BUILD-SNAPSHOT","APP_IS_DEFAULT":true,"metaDataUri":null}',
        createdOn: '2020-05-18T13:24:00Z',
        auditAction: 'CREATE',
        auditOperation: 'APP_REGISTRATION',
        platformName: null,
      ...
      },
      {
        ...
        correlationId: 'mmmmm',
        auditData:
          '{"APP_NAME":"mmmmm","APP_TYPE":"processor","APP_VERSION":"1.0.0.BUILD-SNAPSHOT","uri":"maven://io.spring.cloud:scdf-sample-app:jar:1.0.0.BUILD-SNAPSHOT","APP_IS_DEFAULT":true,"metaDataUri":null}',
