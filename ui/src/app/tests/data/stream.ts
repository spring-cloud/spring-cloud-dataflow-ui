...
export const GET_PLATFORMS = [
  {
    ...
    type: 'local',
    description:
      'ShutdownTimeout = [30], EnvVarsToInherit = [TMP,LANG,LANGUAGE,LC_.*,PATH,SPRING_APPLICATION_JSON], JavaCmd = [/opt/openjdk/bin/java], WorkingDirectoriesRoot = [/tmp], DeleteFilesOnExit = [true]'
  }
];
