...
describe('manage/apps/apps.component.ts', () => {
  ...
  it('should display the group mode', async (done) => {
    ...
    const btnAddApplications = fixture.debugElement.query(By.css('#btnAddApplications'));
    ...
    expect(btnAddApplications).toBeNull();
  ...
  it('should navigate to the application details page (menu)', async (done) => {
    ...
    await fixture.whenStable();
    fixture.detectChanges();
    expect(navigate).toHaveBeenCalledWith('manage/apps/processor/aggregator');
    done();
  });
  ...
  it('should navigate to the add page', async (done) => {
    ...
    fixture.detectChanges();
    expect(navigate).toHaveBeenCalledWith('manage/apps/add');
    done();
  });
